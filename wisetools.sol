...
contract WiseTools is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"WiseTools";
    ...
    constructor () {
        _taxWallet = payable(0x61865c3b7d6e5C5d0D50713e05b1958251A23f64);
